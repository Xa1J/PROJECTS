...
include_once('../functions/common_functions.php'); // Adjusted path to include common functions
session_start();
if (!$con) {
...
<head>
    ...
    <title>Hidden Store - Jerseys</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <?php if(!isset($_SESSION['username'])) {
                            echo "<li class='nav-item'><a class='nav-link' href='../users_area/profile.php'><span class='nav-text'><h1>My Account</h1></span></a></li>";   
                        } else {
