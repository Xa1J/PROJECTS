...
<head>
    ...
    <title><?php echo __('shoes', 'title'); ?></title>
...
<header>
    ...
    <ul class="Centered-links">
        ...
        <li><a href="shoes.php" target="_self"><?php echo __('common', 'shoes'); ?></a></li>
...
<div class="container">
  <a href="shopshoes.php" class="background">
    <section>
      <div class="content-wrapper">
        <img src="main-page-pictures/logo.png" alt="">
        <p class="content-title"><?php echo __('shoes', 'nike'); ?></p>
        <p class="content-subtitle"><?php echo __('shoes', 'subtitle'); ?></p>
      </div>
    </section>
  </a>
  <a href="shopshoes.php" class="background">
    <section>
      <div class="content-wrapper">
        <p class="content-title"><?php echo __('shoes', 'adidas'); ?></p>
        <p class="content-subtitle"><?php echo __('shoes', 'subtitle'); ?></p>
      </div>
    </section>
  </a>
  <a href="shopshoes.php" class="background">
    <section>
      <div class="content-wrapper">
        <p class="content-title"><?php echo __('shoes', 'new_balance'); ?></p>
        <p class="content-subtitle"><?php echo __('shoes', 'subtitle'); ?></p>
      </div>
    </section>
  </a>
  <a href="shopshoes.php" class="background">
    <section>
      <div class="content-wrapper">
        <p class="content-title"><?php echo __('shoes', 'puma'); ?></p>
        <p class="content-subtitle"><?php echo __('shoes', 'subtitle'); ?></p>
      </div>
    </section>
  </a>
  <a href="shopshoes.php" class="background">
    <section>
      <div class="content-wrapper">
        <p class="content-title"><?php echo __('shoes', 'vans'); ?></p>
        <p class="content-subtitle"><?php echo __('shoes', 'subtitle'); ?></p>
      </div>
    </section>
  </a>
  <a href="shopshoes.php" class="background">
    <section>
      <div class="content-wrapper">
        <p class="content-title"><?php echo __('shoes', 'converse'); ?></p>
        <p class="content-subtitle"><?php echo __('shoes', 'subtitle'); ?></p>
      </div>
    </section>
  </a>
  <a href="shopshoes.php" class="background">
    <section>
      <div class="content-wrapper">
        <p class="content-title"><?php echo __('shoes', 'smart_shoes'); ?></p>
        <p class="content-subtitle"><?php echo __('shoes', 'smart_shoes_subtitle'); ?></p>
      </div>
    </section>
  </a>
</div>
